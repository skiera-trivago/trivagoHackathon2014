    ...
    function (dojo, declare, html, arr, lang, dom, Map, GfxLayer, ItemFileReadStore, PortRenderer, LegsRenderer) {
        ...
        return declare(null, {
            constructor: function () {
                ...
                this.loadCountries("data/country_list.json");
            },
            ...
            gotCountries: function (items, request) {
            ...
            loadCountries: function (dataSet) {
                var store = new ItemFileReadStore({
                    url: dataSet,
                    urlPreventCache: true
                });
                ...
                store.fetch({
                    onComplete: lang.hitch(this, this.gotCountries),
                    onError: lang.hitch(this, this.loadError)
                });
            },
